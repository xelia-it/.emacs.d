...
This configuration is compatible with *Emacs 29.1+* and
...
* Open Emacs. Emacs should show message "Byte-compiling init file..."
...
* At the end the main Emacs window should appear.
  The first time some compilation *warnings* can appear: you can ignore them.
