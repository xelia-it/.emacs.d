...
#+BEGIN_SRC emacs-lisp :tangle yes
    (defun my-lsp-settings()
      ...
      ;; Se le signature appaiono ancora, puoi provare a rimuovere l'hook
    ;; Attenzione: questo disabilita tutte le informazioni eldoc da lsp-mode.
      (remove-hook 'eldoc-documentation-functions #'lsp-eldoc-function)
      (setq eldoc-documentation-strategy 'ignore)
      (setq eldoc-documentation-functions
          (delete 'flymake-eldoc-function eldoc-documentation-functions))

      ;;    (setq lsp-eldoc-enable-hover nil)  ;; No function info
      ;;  (setq lsp-signature-auto-activate nil)
      ;;(setq lsp-signature-render-documentation nil) ;; Do not show signature documentation
