...
#+BEGIN_SRC emacs-lisp :tangle yes
  (use-package web-mode
    ...
    :hook (web-mode . (lambda ()
                        ...
                        (when-let* ((props (editorconfig-get-properties))
                                    (indent (gethash 'indent_size props)))
                          (setq web-mode-markup-indent-offset (string-to-number indent))
                          (setq web-mode-css-indent-offset (string-to-number indent))
                          (setq web-mode-code-indent-offset (string-to-number indent)))))
    )
#+END_SRC
