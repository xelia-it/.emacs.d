...
#+BEGIN_SRC emacs-lisp :tangle yes
  (defun my-enable-editorconfig ()
    "Activate editorconfig-mode only inside a project."
  ...
  (use-package editorconfig
    :ensure t
    :defer t
    :hook (prog-mode . my-enable-editorconfig))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp :tangle yes
  (use-package lsp-mode
    ...
    :hook (
           ...
           ;; Enable languages (fallback normal syntax highlight)
           ;; (sh-mode            . lsp)
           ;;     (css-mode           . lsp)
           ;;       (scss-mode          . lsp)
           ;;    (ruby-mode          . lsp)
