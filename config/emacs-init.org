...
#+BEGIN_SRC emacs-lisp :tangle yes
  (defun my-lsp-ui-settings()
    ...
    (setq lsp-signature-auto-activate nil)  ;; Disabilita signature in the minibuffer
    ;;(setq lsp-signature-render-documentation nil)  ;; Evita che mostri i dettagli nella firma
    ;;(setq lsp-eldoc-enable-hover nil))  ;; Impedisce che `eldoc` mostri info sulle funzioni
