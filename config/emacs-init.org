...
#+BEGIN_SRC emacs-lisp :tangle yes
    ...
    ;;    ;; (set-face-foreground 'highlight-indent-guides-even-face "#404040")
    ;;    ;; (set-face-foreground 'highlight-indent-guides-character-face "#404040")
    ;;    ;; (set-face-foreground 'highlight-indent-guides-top-odd-face "#707070")
    ;;    ;; (set-face-foreground 'highlight-indent-guides-top-even-face "#707070")
    ...
    ;;     )
     ...
     (use-package highlight-indent-guides
       ...
       (setq highlight-indent-guides-auto-enabled nil) ; Usa colori manuali
       :config
