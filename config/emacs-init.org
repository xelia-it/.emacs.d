  ...
  (defun my-set-default-font()
    ...
    (cond
     ...
     ((find-font (font-spec :name "Consolas"))
      (set-face-attribute 'default nil :family "Consolas" :slant 'normal :weight 'normal :height 110)
      )

     ((find-font (font-spec :name "Monaco"))
      (set-face-attribute 'default nil :family "Monaco" :slant 'normal :weight 'normal :height 110)
      )
